...
public class CaseFrame {
	...
	/**
	 * The name of the semantic class that represents the default semantic type of any node 
	 * 	with a down-cable set implementing this case frame.
	 */
	private String semanticClass;
	
	/**
	 * The relations included in the current case frame along with their adjustability and
	 * 	limit constraints within this case frame.
	 */
	private Hashtable<String, RCFP> relations;

	/**
	 * A list of strings representing the IDs of the case frame signatures included in the
	 * 	current case frame. The main aim of this is to enforce priority while checking the 
	 * 	case frame signatures during the process of building a node.
	 */
	private LinkedList<String> signatureIDs;
	
	/**
	 * The case frame signatures included in the current case frame. A case frame can have 
	 *  more than one signature and thus the signatures are prioritized.
	 */
	 ...
	 * 	relations included in the case frame separated by commas after sorting them according 
	 * 	to their lexicographical order. Each case frame has a unique set of relations and that 
	 * 	is why the string id composed of the relations included in the case frame will be unique 
	 * 	for each case frame.
	 */
	private String id;
	...
	/**
	 * This method is invoked by the constructor to generate the hash table of relations (RCFP) 
	 * 	from the linked list of relations (RCFP) that was passed to the constructor as a parameter.
	 * 	Each entry in the hash table generated has the relation name as the key and the RCFP
	 * 	of the corresponding relation as the value.
	 * 
	 * @param r
	 * 			a linked list of RCFP representing the relations included in the current case frame.
	 * 
	 * @return the hash table of the relations. (Each entry has the relation name as the key and the 
	 * 	RCFP of the corresponding relation as the value).
	 */
	 ...
	 * 
	 * @return true if the case frame signature was added successfully, and false otherwise.
	 * 	(The same case frame signature (same id) cannot be added twice).
	 */
	 ...
	 * 
	 * @return true if the case frame signature was removed successfully, and false otherwise.
	 */
	...
	/**
	 * 
	 * @return the linked list that contains the IDs of the case frame signatures ordered 
	...
	/**
	 * 
	 * @return the name of the default semantic class specified by the 
	 * 	current case frame.
	 */
	 ...
	 * 	relations included in the case frame along with their corresponding RCFP.
	 */
	 ...
	 * 
	 * @return the RCFP of the given relation and null if the relation 
	 * 	is not included in the current case frame.
	 */
