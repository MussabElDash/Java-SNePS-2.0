...
public class NodeSet {
	 ...
	 * 
	 * @param nodeSet
	 * 			a given node set that all its elements (nodes) will be added to the 
	 * 			current node set.
	 */
	 ...
	 * 			a given node set.
	 * 
	 * @return a new node set that contains the intersection between the nodes in the
	 * 	given node set and the nodes in the current node set.
	 */
	 ...
	 * @param ns
	 * 			a given node set.
	 * @return a new node set that contains the nodes that exist in the current node set
	 * 	but do not exist the given node set.
	 */
	 ...
	 * 
	 * @param obj
	 * 			an Object that is to be compared to the current node set to check whether they are equal.
	 * 
	 * @return true if the given object is an instance of the node set class and has exactly the same 
	 * 	elements (nodes) as the current node set
	 */
	@Override
