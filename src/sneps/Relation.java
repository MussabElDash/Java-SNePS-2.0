...
public class Relation {
	...
	/**
     * the string that represents the adjustability of the relation. It can be one of three 
     * 	options: 'reduce', 'expand' or 'none'.
     */
	private String adjust;
	
	/**
     * the number that represents the minimum number of nodes that this relation can point to 
     * 	within a down-cable.
     */
	private int limit;
	...
	/**
     * a boolean that tells whether this relation is a quantifier relation
     * 	(true if the relation is a quantifier, and false otherwise).
     */
	 ...
	 * 				'expand' if the relation is expandable.
	 * 				'none' if the relation is neither reducible nor expandable.
	 * @param l
	...
	/**
     * @return the name of the semantic type of the nodes that 
     * 	can be pointed to by the current relation.
     */
	...
	/**
     * @return the adjustability of the current relation.
	...
	/**
     * @return the path defined for the current relation. 
     * 	(can return null if there is no defined path for the current relation).
     */
	public Path getPath(){
		return this.path;
	}
	...
	/** 
	 * @param path
	 *  		a Path that will be defined for the current relation to be used 
	 * 			in path-based inference.
	 */
	...
	/**
	 * This method sets the boolean quantifier to true if the name of the current relation 
	 * 	represents a quantifier relation.
	 */
	 ...
	 * 
	 * @param obj
	 * 			an Object that is to be compared to the current relation to check whether they are equal.
	 * 
	 * @return true if the given object is an instance of the Relation class and has the same name as 
	 * 	the current relation, and false otherwise.
	 */
	@Override
